...
static const char *notify_names[]			=   {
										...
										"Transliterate selected text", "Change case of selected text", "Calculate formula on selected text", "Preview correcting of selected text",
										"Correct clipboard text", "Transliterate clipboard text", "Change case of clipboard text", "Calculate formula on clipboard text", "Preview correcting of clipboard text",
...
static const char *hotkey_names[]			=   {
										...
										"Correct selected text", "Transliterate selected text", "Change case of selected text", "Calculate formula on selected text", "Preview correcting of selected text",
	                                    "Correct clipboard text", "Transliterate clipboard text", "Change case of clipboard text","Calculate formula on clipboard text", "Preview correcting of clipboard text",
