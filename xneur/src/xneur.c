...
static void xneur_load_config(int final)
{
	...
	log_message(LOG, _("Correct of spaces before punctuation mode set to %s"), xconfig->get_bool_name(xconfig->correct_space_before_punctuation));
	log_message(LOG, _("Correct of spaces after punctuation mode set to %s"), xconfig->get_bool_name(xconfig->correct_space_after_punctuation));
