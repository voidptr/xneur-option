...
struct _xneur_config
{
	...
	int   correct_space_before_punctuation;	// Correct spaces before punctuation
	int   correct_space_after_punctuation;	// Correct spaces after punctuation
	int   correct_capital_letter_after_punctuation;
